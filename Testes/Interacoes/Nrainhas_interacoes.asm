		.data
cont_inter:	.double 1.0
tabuleiro:	.space 100
cont:		.space 4
cham:		.asciiz	"Insira o valor de n:"
...
.globl main
main:
	l.d	$f0, cont_inter		# Carrega contador de interacoes
	la 	$t9, cont		# Carrega endereco do contador 
	li 	$t8, 0			# Inicia $t8 = 0
	sw 	$t8, ($t9)		# Salva o valor 0 no contador
	
	la 	$a0, cham		# Imprime "Insira o valor de n:"
	li 	$v0, 4
	syscall			
